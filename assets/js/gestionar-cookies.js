...
function checkCookiesStatics() {
    return docCookies.hasItem('adt_cookies_estadisticas');
}
function checkCookie() {
    ...
    if (docCookies.hasItem('adt')) {
        return true;
    } else {
        docCookies.setItem('adt', 'adt', caduca);
        return false;
    }
...
function acceptCookie(cookie, accept) {
    if (!docCookies.hasItem('adt'))
        docCookies.setItem('adt', 'adt', caduca);
    if (!docCookies.hasItem('adt_cookies_necesarias'))
        docCookies.setItem('adt_cookies_necesarias', 'adt_cookies_necesarias', caduca);
